// src/components/sections/WhatSecondarySection.tsx

import { type TextSectionProps } from "@/types/sections";

export function WhatSecondarySection({ section }: TextSectionProps) {
    ...
    <section className="bg-card text-foreground">
      ...
      <div className="container px-4 sm:px-6 lg:px-8 xl:px-10 py-6 md:py-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch">
         ...
         <div className="bg-secondary py-6 md:py-8 flex items-center text-justify">
           <div className="px-10 text-right">
              <h2 className="text-2xl md:text-3xl font-headline font-semibold leading-tight text-left md:text-right text-card">
                {(heading || "")
                  .split(/\r?\n/)
