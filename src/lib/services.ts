...
export const services: Service[] = [
  ...
  description: `Whether you need a survey for a workplace noise assessment, ongoing noise monitoring for an operational site, or an environmental noise survey to support a planning application or the design of your project, our service is delivered with a focus on accuracy, clarity and competitive pricing.

Our surveys are carried out using precision instrumentation and follow current British Standards and recognised best-practices, including BS7445, BS8233, BS4142 and the Control of Noise at Work Regulations.
...
Our modern, efficient acoustic survey and analysis methods help keep everything clear and straightforward, with results that are technically robust, easy to understand and ready to use. A streamlined approach supports quick turnaround times, strong technical confidence and excellent value. From early design advice to full compliance reporting, our clients receive clear, reliable information they can act on with confidence.`,
  ...
  description: `Whether you need a noise impact assessment to support your planning application, to inform the design of your scheme or to demonstrate compliance with specific performance requirements, we can help. With years of experience delivering noise impact assessments for a wide spectrum of projects across the built environment, we provide clear, reliable guidance to help clients meet planning and compliance requirements.

We understand that every project is unique, with its own challenges and requirements. Our services are therefore tailored to suit each and every project ensuring the process, information, level of detail and the design solutions meet the project's specific needs. 

Our modern processes are highly efficient making use of the latest technologies to effectively support the design process, by identifying and mitigating risk early, ensuring accurate and robust assessments whilst adopting the appropriate level of tolerance for your and your projects needs.
...
`,
  ...
  description: `With experience combining extensive technical expertise with strategic planning insight, we deliver robust assessments, compliant reports, and practical mitigation solutions that secure planning approval.
